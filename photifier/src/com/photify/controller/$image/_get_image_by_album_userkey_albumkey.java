...
// Controller for com.photify.ImagePage#getImagesByAlbum
// @javax.annotation.Generated
public final class _get_image_by_album_userkey_albumkey extends scenic3.ScenicController {

    private final com.photify.ImagePage page;

    public _get_image_by_album_userkey_albumkey() {
    ...
    public final org.slim3.controller.Navigation run() throws Exception {
        return page.getImagesByAlbum(super.var("userkey"), super.var("albumkey"), super.var("imagekey"));
    }
